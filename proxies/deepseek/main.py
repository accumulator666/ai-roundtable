...
app = FastAPI(title="DeepSeek Proxy", version="1.0.0")
...
async def list_models():
    return {
        "object": "list",
        "data": [
            {"id": m, "object": "model", "created": int(time.time()), "owned_by": "deepseek"}
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "deepseek-proxy", "models": AVAILABLE_MODELS}
